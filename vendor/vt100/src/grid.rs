...
impl Grid {
    ...
    pub fn visible_rows(&self) -> impl Iterator<Item = &crate::row::Row> {
        ...
        // omanote patch: upstream 0.15.2 computes `rows_len - scrollback_offset`
        // unchecked, which overflows (and panics) as soon as the view is
        // scrolled back further than one screen. Saturate, and never yield
